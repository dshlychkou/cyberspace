...
- **Starvation** — Data drops to 0. Every program costs 1 Data/tick upkeep. Without vault income, your starting 150 Data runs out fast and all programs die.
- **ICE overrun** — When ICE outnumbers your programs on a node, all programs there are destroyed. If ICE wipes your last program, it's game over.
...
| `--cyberspace_event_log_file`         | `CYBERSPACE_EVENT_LOG_FILE`         | `./lastgame.log`    | File path for JSON event log (empty = disabled)   |
