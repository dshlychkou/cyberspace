...
type Config struct {
	...
	CoreWinDuration     int           `name:"core_win_duration"  default:"12"   usage:"consecutive ticks holding core to win"`
	DataHarvestRate     int           `name:"data_harvest_rate"     default:"5"    usage:"data earned per tick per program on a vault"`
	ComputeHarvestRate  int           `name:"compute_harvest_rate"  default:"2"    usage:"compute earned per tick per program on a relay"`
	ProgramSpawnCost    int           `name:"program_spawn_cost" default:"15"   usage:"data cost to spawn a program"`
	VirusDeployCost     int           `name:"virus_deploy_cost"  default:"20"   usage:"compute cost to deploy a virus"`
	...
	InitialCompute      int           `name:"initial_compute"    default:"40"   usage:"starting compute resource"`
	ICESpawnTick        int           `name:"ice_spawn_tick"         default:"15"   usage:"tick when first new ICE spawns"`
	ICESpawnMinInterval int           `name:"ice_spawn_min_interval" default:"5"    usage:"fastest ICE spawn interval (tick floor)"`
	ICEEscalationTick   int           `name:"ice_escalation_tick"    default:"60"   usage:"tick when ICE escalation starts"`
